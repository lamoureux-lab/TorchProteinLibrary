...
cGeometry::cGeometry(){
    ...
    //OG serine
    R_CB_OG = 1.417;
    CA_CB_OG_angle = -(M_PI - M_PI*110.773/180.0);
    //SG cysteine
    R_CB_SG = 1.808;
    CA_CB_SG_angle = -(M_PI - M_PI*113.8169/180.0);
    //Valine CG1 and CG2 ???
    R_CB_CG = 1.527;
    CA_CB_CG1_angle = -(M_PI - M_PI*110.7/180.0);
    CA_CB_CG2_angle = -(M_PI - M_PI*110.7/180.0) + M_PI/2;
}
