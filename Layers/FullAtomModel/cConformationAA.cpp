...
cNode *cConformation::addHis(cNode *parentC, std::vector<double*> params){
    cNode *nC, *nCA, *nN, *nCB, *nCG;
    cTransform *bbN_transform, *bbCA_transform, *bbC_transform, *bbCB_transform, *bbCG_transform;
    cRigidGroup *bbCA, *bbC, *bbN, *bbCB, *bbCG;
    // geo.ala();
...
cNode *cConformation::addPro(cNode *parentC, std::vector<double*> params){
    cNode *nC, *nCA, *nN;
    cTransform *bbN_transform, *bbCA_transform, *bbC_transform;
    cRigidGroup *bbCA, *bbC, *bbN;
    // geo.ala();
...
cNode *cConformation::addPhe(cNode *parentC, std::vector<double*> params){
   cNode *nC, *nCA, *nN, *nCB, *nCG;
    cTransform *bbN_transform, *bbCA_transform, *bbC_transform, *bbCB_transform, *bbCG_transform;
    cRigidGroup *bbCA, *bbC, *bbN, *bbCB, *bbCG;
...
cNode *cConformation::addTyr(cNode *parentC, std::vector<double*> params){
   cNode *nC, *nCA, *nN, *nCB, *nCG;
    cTransform *bbN_transform, *bbCA_transform, *bbC_transform, *bbCB_transform, *bbCG_transform;
    cRigidGroup *bbCA, *bbC, *bbN, *bbCB, *bbCG;
...
cNode *cConformation::addTrp(cNode *parentC, std::vector<double*> params){
   cNode *nC, *nCA, *nN, *nCB, *nCG;
    cTransform *bbN_transform, *bbCA_transform, *bbC_transform, *bbCB_transform, *bbCG_transform;
    cRigidGroup *bbCA, *bbC, *bbN, *bbCB, *bbCG;
