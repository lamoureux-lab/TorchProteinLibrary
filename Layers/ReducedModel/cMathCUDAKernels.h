...
__device__ void getRotationMatrixDihedral(REAL *d_data, REAL psi, REAL kappa, REAL R);
__device__ void getRotationMatrixDihedralDPsi(REAL *d_data, REAL psi, REAL kappa, REAL R);
...
__device__ REAL vec3Mul(REAL *v1, REAL *v2);
