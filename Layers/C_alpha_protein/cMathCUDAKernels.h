...
extern __device__ void getRotationMatrixCalpha(float *d_data, float phi, float psi);
extern __device__ void getRotationMatrixCalphaDPhi(float *d_data, float phi, float psi);
extern __device__ void getRotationMatrixCalphaDPsi(float *d_data, float phi, float psi);
