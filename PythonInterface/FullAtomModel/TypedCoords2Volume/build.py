...
sources = [ os.path.join(lib_dir,'Layers/FullAtomModel/TypedCoords2Volume/typedcoords2volume_interface.cpp'),
			]
headers = [	os.path.join(lib_dir,'Layers/FullAtomModel/TypedCoords2Volume/typedcoords2volume_interface.h'),
			]
...
if __name__ == '__main__':
	...
	print cppTypedCoords2Volume.__dict__.keys()
