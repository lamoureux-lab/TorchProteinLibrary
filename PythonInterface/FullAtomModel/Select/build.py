...
sources = [ os.path.join(lib_dir,'Layers/FullAtomModel/Select/select_interface.cpp'),
            ]
headers = [	os.path.join(lib_dir,'Layers/FullAtomModel/Select/select_interface.h'),
			]
