...
sources = [ os.path.join(lib_dir,'Layers/FullAtomModel/Angles2Coords/angles2coords_interface.cpp')
            ]
headers = [	os.path.join(lib_dir,'Layers/FullAtomModel/Angles2Coords/angles2coords_interface.h')
			]
...
if __name__ == '__main__':
	...
	print cppAngles2Coords.__dict__.keys()
