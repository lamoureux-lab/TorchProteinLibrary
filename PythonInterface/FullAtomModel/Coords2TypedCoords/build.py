...
sources = [ os.path.join(lib_dir,'Layers/FullAtomModel/Coords2TypedCoords/coords2typedcoords_interface.cpp')
			]
headers = [	os.path.join(lib_dir,'Layers/FullAtomModel/Coords2TypedCoords/coords2typedcoords_interface.h')
			]
...
if __name__ == '__main__':
	...
	print cppCoords2TypedCoords.__dict__.keys()
