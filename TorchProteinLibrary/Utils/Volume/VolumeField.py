...
class ScalarField():
	...
	def isosurface(self, isovalue, axis=None, args = {}):
		import matplotlib.pyplot as plt
		from mpl_toolkits.mplot3d.art3d import Poly3DCollection
		from skimage import measure
		verts, faces, normals, values = measure.marching_cubes_lewiner(self.T.cpu().numpy(), isovalue)
...
if __name__=='__main__':
	...
	ScalarField(scalar_field).isosurface(2.0)
