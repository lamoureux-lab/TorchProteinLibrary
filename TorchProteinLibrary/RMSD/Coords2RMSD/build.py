...
sources = [ os.path.join(lib_dir,'Layers/FullAtomModel/Coords2RMSD/coords2rmsd_interface.cpp'),
            ]
headers = [	os.path.join(lib_dir,'Layers/FullAtomModel/Coords2RMSD/coords2rmsd_interface.h'),
			]
...
if __name__ == '__main__':
	...
	print cppCoords2RMSD.__dict__.keys()
